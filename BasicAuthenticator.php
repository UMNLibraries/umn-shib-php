...
class BasicAuthenticator implements BasicAuthenticatorInterface
{
  ...
  protected static function checkArgSeparatorValue()
  {
    ...
    if ($arg_sep != "&") {
      trigger_error("The core php.ini directive 'arg_separator.output' has non-default value $arg_sep. URLs generated by UMNShib\Basic\BasicAuthenticator may not function unless arg_separator.output has the value '&'", E_USER_WARNING);
    }
  }
}
?>
